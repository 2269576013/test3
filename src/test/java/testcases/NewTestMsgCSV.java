...
public class NewTestMsgCSV {
  ...
  public void testUntitled() throws Exception {
    ...
    driver.findElement(Utils.getLocator("name_editbox_locator")).sendKeys(Utils.getCSVTestData("name"));
    driver.findElement(Utils.getLocator("email_editbox_locator")).clear();
    driver.findElement(Utils.getLocator("email_editbox_locator")).sendKeys(Utils.getCSVTestData("email"));
    driver.findElement(Utils.getLocator("msg_editbox_locator")).clear();
    driver.findElement(Utils.getLocator("msg_editbox_locator")).sendKeys(Utils.getCSVTestData("msg"));
